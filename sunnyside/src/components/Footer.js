...
export default function Footer() {
  ...
  return (
    <div className='bg-[#90D4C6] flex flex-col items-center pt-16 pb-16'>
        <img src={Logo} alt="logo" className='w-[123px] h-[24px]'/>
            <ul className='flex w-10/12 justify-between pt-12 font-barlow font-semibold text-[#458D7E] md:w-1/3 lg:w-1/5'>
                <li className='hover:text-white hover:cursor-pointer'>About</li>
                <li className='hover:text-white hover:cursor-pointer'>Services</li>
                <li className='hover:text-white hover:cursor-pointer'>Projects</li>
            </ul>

            <ul className='flex w-1/2 justify-between pt-12 lg:w-44'>
                <li>
                    <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" className='text-[#2C7566] hover:text-white fill-current hover:cursor-pointer'>
